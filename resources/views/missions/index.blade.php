   ...
   <div class='title'>Nos missions </div><br/>
      ...
      <div class="form-group {!! $errors->has('nom_mission') ? 'has-error' : '' !!}">
        <fieldset>
          ...
          {!! $errors->first('nom_mission', '<small class="help-block" style="color: red;">:message</small>') !!}

          {!! Form::text('auteur_mission', null, ['class' => 'form-control', 'placeholder' => 'Auteur(s) de la mission']) !!}<br/><br/>
          {!! $errors->first('auteur_mission', '<small class="help-block" style="color: red;">:message</small>') !!}
		  </div>
		  </div>
          ...
          {!! $errors->first('map_mission', '<small class="help-block" style="color: red;">:message</small>') !!}
		  </div>
          ...
          {!! $errors->first('composante_mission', '<small class="help-block" style="color: red;">:message</small>') !!}
          ...
          {!! $errors->first('nombre_slots_mission', '<small class="help-block" style="color: red;">:message</small>') !!}
		  </div>
          ...
          {!! $errors->first('correction_mission', '<small class="help-block" style="color: red;">:message</small>') !!}
		  </div>
          ...
          {!! $errors->first('zeus_mission', '<small class="help-block" style="color: red;">:message</small>') !!}
		  </div>
          ...
          {!! $errors->first('briefing_mission', '<small class="help-block" style="color: red;">:message</small>') !!}
		  </div>
          ...
          {!! $errors->first('hostile_mission', '<small class="help-block" style="color: red;">:message</small>') !!}
		  </div>


          <div class="form-group {!! $errors->has('duree_estimee_mission') ? 'has-error' : '' !!}">
          Durée estimée :<br>&nbsp&nbsp&nbsp&nbsp{!! Form::text('duree_estimee_mission', null, ['class' => 'form-control', 'placeholder' => 'Durée estimée']) !!} h<br/><br/>
          {!! $errors->first('duree_estimee_mission', '<small class="help-block" style="color: red;">:message</small>') !!}
		  </div>
          ...
          {!! $errors->first('statut', '<small class="help-block" style="color: red;">:message</small>') !!}
		  </div>
          ...
          {!! $errors->first('nombre_jouer_mission', '<small class="help-block" style="color: red;">:message</small>') !!}
		  </div>
          ...
          {!! $errors->first('type_mission', '<small class="help-block" style="color: red;">:message</small>') !!}
